...
Checking Serial Port...
	Ok: the port "/dev/ttyACM0" exists and is writeable

Checking Board Model...
	Ok: the board is "arduino" "uno" with PID "0043"

Checking Arduino software directory...
	Ok: "/usr/share/arduino" folder exists

Checking Arduino.mk file...
	Ok: the file "/usr/share/arduino/Arduino.mk" exist

Searching Arduino libraries...
...
Searching Arduino libraries...
	Libraries: "OneWire", "DallasTemperature", "LiquidCrystal_I2C", "SPI", "Ethernet", "EEPROM"

Copying source files... 
	Ok: "Arduino-heat-control.ino" copied to "/tmp/gat_build_Arduino-heat-control"

Creating Makefile...
	Ok: Makefile was created
